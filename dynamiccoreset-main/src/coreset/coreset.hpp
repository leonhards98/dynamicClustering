...
namespace coresets
{
    ...
    public:
        ...
        Coreset(size_t targetSize, utils::IndexFinder &i);
        ...
        void writePointsToVector(std::vector<dynClustering::CoresetPoint*>* pointVector, std::vector<dynClustering::CoresetPoint*>* centersVector);
        void writeWeightsToVector(std::vector<double>* weightVector);
         ...
         * @brief Write coreset points to the given output stream.
         */
        void writeCoordsToStream(std::ostream &out);
    };
}
