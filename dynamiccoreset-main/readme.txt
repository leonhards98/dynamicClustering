...
The algorithm maintains a coreset of a dynamic dataset and updates a k-means solution using this coreset.
...
Optional command line arguments are:
	...
	-p The ILP gets a runtime cutoff that is calculated by multiplying this factor with the runtime of the dynamic coreset algorithm
