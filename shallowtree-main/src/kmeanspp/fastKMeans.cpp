...
std::shared_ptr<treeNode> fastKMeansAlgo::multiTreeSample()
{
    ...
    {
        //std::cout << currentNode->lChild->KMeansWeight/(currentNode->lChild->KMeansWeight + currentNode->rChild->KMeansWeight) << " " << static_cast<double>(rand())/RAND_MAX << "\n";
