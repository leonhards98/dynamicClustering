This repository contains the source code of a program related to the arcticle "Experimental Evaluation of Fully Dynamic k-Means via Coresets"

The algorithm maintains a coreset of a dynamic dataset and updates a k-means solution using this coreset. Here, a shallow tree is used.
...
The height of the tree can be set to x, by renaming the folder "src/dynamic_coreset_hx" to "src/dynamic_coreset"
The arity of the used tree can be modifyied in src/dynamic_coreset/coreset_tree.h on line 16.
---Input File Format---
